...
public class PostingPeriod {
    ...
    public BigDecimal calculateInterest(final CompoundInterestValues compoundInterestValues) {
        ...
        for (final CompoundingPeriod compoundingPeriod : this.compoundingPeriods) {
			...
			BigDecimal unCompoundedInterest = compoundInterestValues.getInterestToBeUncompounded().add(interestUnrounded);
			compoundInterestValues.setInterestToBeUncompounded(unCompoundedInterest);
			
			LocalDate compoundingPeriodEndDate = determineInterestPeriodEndDateFrom(compoundingPeriod.getPeriodInterval().startDate(),
			...
			if(compoundingPeriodEndDate.equals(compoundingPeriod.getPeriodInterval().endDate())) {
				BigDecimal interestCompounded = compoundInterestValues.getInterestatoBeCompounded().add(unCompoundedInterest);
